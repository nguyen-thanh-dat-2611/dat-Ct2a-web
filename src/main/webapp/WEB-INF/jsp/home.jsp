...
<html>
    ...
    <body>
        ...
        <div class="container" >
            ...
            <div class="row">
                <c:forEach var="products" items="${newProduct}">
                    <div class="col-md-3 col-sm-6"> 
                        <div class="card">
                            <div class="card-block">
                                ...
                                <a style="margin-top: 10px;" href="${pageContext.request.contextPath}/detail/${products.id}" class="btn btn-danger">Xem Chi Tiết</a>
                            </div>
                        </div>
                    </div>
                </c:forEach>
            ...
            <div class="row">
                <c:forEach var="products" items="${sellingList}">
                    <div class="col-md-3 col-sm-6"> 
                        <div class="card">
                            <div class="card-block">
                                <a href="#"><img class="card-img-top" src="${pageContext.request.contextPath}/resources/images/${products.image}" alt=""></a>
